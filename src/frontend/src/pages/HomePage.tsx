...
export default function HomePage() {
  return (
    <div>
      {/* Hero */}
      <section className="bg-gradient-to-br from-sky-700 to-sky-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          ...
          <Link
            to="/search"
            className="inline-block bg-white text-sky-800 font-semibold px-8 py-3 rounded-lg hover:bg-sky-50 transition-colors"
          >
            Ver Imóveis
          </Link>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="text-3xl font-bold text-sky-600 mb-2">Pombal</div>
